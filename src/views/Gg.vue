<template>
    <div class="relative md:hidden  h-screen bg-black z-[20]">
        ...
        <!-- BODY carta -->
        <div :class="{ 'top-[-5px]': !scroll, 'top-[910px]': scroll }"
            ...
            <!-- sect 1 -->
            <div class="px-[30px] pt-[100px] leading-[50px] font-extrabold text-[40px] text-[rgba(0,0,0,0.52)]">Mi chiamo Antonino e non sono solo un Web Developer!</div>

            <!-- img 1 home -->
            <img src="../assets/disegno.png" alt="" class="px-[20px] w-screen pt-[30px]">

            <!-- 1 descrizione -->
            <div class="font-semibold text-[rgba(0,0,0,0.86)] text-[20px] px-[30px] pt-[40px]">
            ...
            <!-- img 2 home -->
            <img src="../assets/sedia.png" alt="" class="px-[20px] w-[75%] pt-[20px]">

            <!-- 2 descrizione -->
            <div class="font-semibold text-[rgba(0,0,0,0.86)] text-[20px] px-[30px] pt-[20px] pb-[70px]">
