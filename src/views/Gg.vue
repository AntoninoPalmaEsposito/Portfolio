<template>
    <div class="relative md:hidden  h-screen bg-black z-[20]">
        ...
        <div :class="{ 'top-[-10px]': scroll, 'top-[140vh]': !scroll }"
            ...
            <!-- sect 1 -->
            <div class=" px-[5.5vw] pt-[12vw] w-screen leading-[8vw] font-extrabold text-[8vw]  text-[rgba(0,0,0,0.52)]">Mi
                chiamo Antonino e <br> non sono solo un Web Developer    v</div>
