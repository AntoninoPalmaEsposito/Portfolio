...
<!-- container/input mouse -->
  <div @wheel="handleMouseWheel" class=" w-screen bg-black">
    ...
    <div class="relative">
      ...
      <!-- nav coperta -->
      <div class="absolute top-0 left-0 bg-red-400  h-[300px] w-screen z-20 opacity-25">
      </div>

     
      <!-- body carta -->
      <div :id="customId" :class="scendi" class=" z-10 w-screen h-screen  translate-y-6  absolute top-[-50px] ">
